            ...
            <thead>
             ...
             <tbody id="webusers-list" name="webusers-list">
               @foreach ($webusers as $webuser)
                <tr id="webuser{{$webuser->id}}">
                 <td>{{$webuser->id}}</td>
                 <td>{{$webuser->nama}}</td>
                 <td>{{$webuser->alamat}}</td>
                  <td>
                  <button class="btn btn-warning btn-detail open_modal" value="{{$webuser->id}}">Edit</button>
                  <button class="btn btn-danger btn-delete delete-webuser" value="{{$webuser->id}}">Delete</button>
                  </td>
                </tr>
                @endforeach
            </tbody>
